...
image_prompt_pairs = [
    ("/data/data/shibu/HiDream-I1/datasets/generated/animals/set_0/997_333353.png", "head."),
    ("/data/data/shibu/HiDream-I1/datasets/generated/animals/set_0/8_758246.png", "wings."),
    # ("/data/data/shibu/HiDream-I1/datasets/generated/animals/set_1/1012_787888.png", "elephant trunk."),
]

JSON_FILE = "/data/data/shibu/PiT/scripts/animal-image-pairs.json"
...
def main(cfg: RunConfig):
    ...
    crop_base_dir = Path("/data/data/shibu/PiT/inference/output")
    all_crop_paths = []
    ...
    crop_sets = list(combinations(all_crop_paths, 3))
